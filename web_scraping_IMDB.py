...
new_df = pd.DataFrame({'movie name': movie_names, 'year': years, 'IMDB rating':IMDB_ratings, 
                       'votes': votes, 'genre': movie_genre, 'movie gross' : movie_gross, 'runtime': new_time})
...
new_df2 = pd.DataFrame({'movie name': movie_names2, 'year': years2, 'IMDB rating':IMDB_ratings2,
                        'votes': votes2, 'genre': movie_genre2, 'movie gross' : movie_gross2, 'runtime': new_time2})
#print(new_df2)
...
new_df3 = pd.DataFrame({'movie name': movie_names3, 'year': years3, 'IMDB rating':IMDB_ratings3,
                        'votes': votes3, 'genre': movie_genre3, 'movie gross' : movie_gross3, 'runtime': new_time3})
...
new_df4 = pd.DataFrame({'movie name': movie_names4, 'year': years4, 'IMDB rating':IMDB_ratings4,
                        'votes': votes4, 'genre': movie_genre4, 'movie gross' : movie_gross4, 'runtime' : new_time4})
...
new_df5 = pd.DataFrame({'movie name': movie_names5, 'year': years5, 'IMDB rating':IMDB_ratings5,
                        'votes': votes5, 'genre': movie_genre5, 'movie gross' : movie_gross5, 'runtime':new_time5})
...
new_gross = []
for number in final_df['movie gross']:
    new_gross.append(int(number.replace(',','')))

final_df['movie gross'] = new_gross

final_df = final_df[final_df['movie gross'] > 250]
